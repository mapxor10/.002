...
module.exports = {
    name: `/bot/control/settings/suggestion/:id/:id/load`,
    type: "get",
    run: async (req, res) => {
        ...
        if (deecoded) {
            ...
            if (req.cookies.token) {
                ...
                let botConfigData = {}
                let botData = new Database("../Bot/Json-Database/Settings/Suggestion.json")
                let systemChannels = botData.get("Suggestion_" + serverId + "_" + id) || []
                let channelsFiltered = []
                let line = botData.get("SuggestionLine_" + serverId + "_" + id)
            ...
            res.render(`./website/html/Pages/Control/Suggestion.ejs`, args);
        } else {
