...
module.exports = {
    name: `/bot/control/settings/autoline/:id/:id/load`,
    type: "get",
    run: async (req, res) => {
        ...
        if (deecoded) {
            ...
            if (req.cookies.token) {
                ...
                let botConfigData = {}
                let botData = new Database("../Bot/Json-Database/Settings/Autoline.json")
                let autolineChannels = botData.get("Autoline_" + serverId + "_" + id) || []
                let channelsFiltered = []
                let line = botData.get("Line_" + serverId + "_" + id)
            ...
            res.render(`./website/html/Pages/Control/Autoline.ejs`, args);
        } else {
